...
function bot_ui_ini() {
    ...
    botui.message.add({
        ...
        botui.message.add({
            ...
            botui.message.add({
                delay: 1100,
                content: "我相信点开这里的你，一定和我有某种缘分才能来到这个私人空间~"
            }).then(function() {
                botui.action.button({
                    delay: 1600,
                    action: [{
    ...
    var sure = function() {
        ...
        secondpart = function() {
            botui.message.add({
                ...
                botui.message.add({
                    delay: 1500,
                    content: "向往管理却误入计算机，但后来喜欢上了coding（hello world）…"
                }).then(function() {
                    botui.message.add({
                        delay: 1200,
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "主攻 Python，熟悉HTML/CSS/JavaScript，略懂 Java（的单词拼写）"
                        }).then(function() {
                            botui.message.add({
                                delay: 1500,
                                content: "研究的方向，是数据挖掘（data mining）城市计算以及机器学习（machine learning）【的名词含义】"
                            }).then(function() {
                                botui.message.add({
                                    delay: 1800,
                                    content: "喜欢做手工，乐于尝试新鲜的东西。希望有一天能够体验有趣不同的小众职业"
                                }).then(function() {
                                    botui.action.button({
                                        delay: 1100,
                                        action: [{
